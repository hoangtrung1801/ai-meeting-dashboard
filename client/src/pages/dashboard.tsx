...
export default function Dashboard() {
  ...
  const { data: recentMeetings, isLoading: isMeetingsLoading } = useQuery<Meeting[]>({
    queryKey: ['/api/meetings/recent'],
  });
  
  // Fetch pending action items
  const { data: actionItems, isLoading: isActionItemsLoading } = useQuery<ActionItem[]>({
  ...
  return (
    <main className="flex-1 relative overflow-y-auto focus:outline-none">
      ...
      <div className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
        ...
        <div className="flex-1 px-4 flex justify-between">
          ...
          <div className="ml-4 flex items-center md:ml-6">
            ...
            {/* Notifications */}
            <button type="button" className="ml-3 p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
      ...
      <div className="py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          {isStatsLoading ? (
            ...
            Array(4).fill(null).map((_, index) => (
              <div key={index} className="bg-white overflow-hidden shadow rounded-lg h-[106px] animate-pulse">
            ...
            <>
              ...
              <StatsCard 
                ...
                additionalText={`${stats?.completedActionItems || 0} completed`}
              />
        ...
        {/* Recent Meetings */}
        <div className="mb-8">
          <h2 className="text-lg font-medium text-dark mb-4">Recent Meetings</h2>
            ...
            <div className="mt-4 text-center">
              <Link href="/meetings">
                <a className="text-primary hover:text-blue-700 font-medium">
                  View all meetings <i className="fas fa-arrow-right ml-1"></i>
                </a>
              </Link>
            </div>
          )}
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-dark">Pending Action Items</h2>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-dark">Upcoming Meetings</h2>
            <Link href="/meetings">
              <a className="text-sm text-primary hover:text-blue-700">View calendar</a>
            </Link>
          </div>
            ...
            <ul className="divide-y divide-gray-200">
              {isMeetingsLoading ? (
                ...
                recentMeetings.slice(0, 2).map((meeting) => {
                  ...
                  return <UpcomingMeeting key={meeting.id} meeting={upcomingMeeting} />;
                })
              ) : (
                <li className="px-4 py-10 text-center text-gray-500">
