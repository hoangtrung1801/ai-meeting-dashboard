...
import { Meeting, api, Transcript } from "@/lib/api";
...
// Update MeetingViewer props type
...
export default function CalendarView() {
    ...
    const { data: meetings, isLoading } = useQuery<Meeting[]>({
        ...
        queryFn: () =>
            api.getMeetingsInRange(getDateRange.start, getDateRange.end),
    });
    ...
    const calendarEvents = useMemo(() => {
        ...
        return meetings.map((meeting) => {
            const start = meeting.startTime
                ...
                : new Date();
            const end = new Date(
                start.getTime() + (meeting.duration || 0) * 60000
            );
                        ...
                        {isLoading ? (
                            ...
                            <div className="h-[600px] calendar-container">
                                <Calendar
                                    ...
                                    formats={
                                        calendarConfig[
                                            view as keyof typeof calendarConfig
                                        ]?.formats
                                    }
                                    eventPropGetter={(event) => {
                                        const meeting =
                                            event.resource as Meeting;
