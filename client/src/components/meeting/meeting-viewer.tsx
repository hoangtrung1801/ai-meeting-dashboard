...
import { Transcript, TranscriptSegment } from "@/lib/api";
...
export function MeetingViewer({
    ...
    const getSpeakers = () => {
        ...
        return Array.from(
            new Set(transcript.content.map((item) => item.speaker))
        );
    };
    ...
    const getFilteredTranscript = () => {
        ...
        return transcript.content.filter((item) => {
            const matchesSearch =
                searchQuery === "" ||
            ...
            <DialogContent className="max-w-4xl h-[80vh] flex flex-col p-0">
                ...
                <div className="flex-shrink-0 px-4 py-4 border-t border-gray-200">
                    <div className="flex justify-between items-center">
                        ...
                        <div>
                            <Button size="sm">Edit Transcript</Button>
                        </div>
                    </div>
                </div>
            </DialogContent>
